...
echo.
echo [5/5] 关联远程仓库并推送...
git remote add origin https://github.com/chiyingtao/chiyingtao.github.io.git
...
echo.
echo 1. 访问 https://github.com/chiyingtao/chiyingtao.github.io/settings/pages
echo 2. 在 "Source" 下选择 "Deploy from a branch"
echo 3. 在 "Branch" 下选择 "main" 和 "/ (root)"
echo 4. 点击 "Save"
echo 5. 等待几分钟后访问：https://chiyingtao.github.io/
echo.
pause
